...
execute if score @s peru.sv.lvl matches ..1 run particle minecraft:ash ~ ~1.5 ~ 0.2 0.2 0.2 5 256
...
data modify storage peru.sv: rod.pos3.sort set value falling_block
data modify storage peru.sv: rod.pos3.block set value air
data modify storage peru.sv: rod.pos3.block set from entity @s Inventory[{Slot:-106b}].id
execute if predicate peru.sv:offhand_water run data modify storage peru.sv: rod.pos3.block set value water
execute if predicate peru.sv:offhand_pearl run data modify storage peru.sv: rod.pos3.sort set value ender_pearl
execute if predicate peru.sv:offhand_tnt run data modify storage peru.sv: rod.pos3.sort set value tnt
execute if predicate peru.sv:offhand_air run data modify storage peru.sv: rod.pos3.sort set value experience_orb
execute if predicate peru.sv:offhand_arrow run data modify storage peru.sv: rod.pos3.sort set value arrow

data modify storage peru.sv: rod.pos3.uuid set from entity @s UUID
execute anchored eyes run function peru.sv:rod/cannon/shot with storage peru.sv: rod.pos3
